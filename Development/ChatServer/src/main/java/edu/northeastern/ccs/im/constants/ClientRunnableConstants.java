...
public final class ClientRunnableConstants {
    ...
    public static final String REGISTER_SUCCESS_MSG = "You have successfully registered as a new user..";
    public static final String REGISTER_FAILURE_MSG = "Invalid credentials..Please try with new user information.";
